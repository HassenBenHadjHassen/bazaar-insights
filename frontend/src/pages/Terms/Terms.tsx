...
const Terms = () => {
  return (
    <div className="termsOfService">
      ...
      <p>
        We are HASSEN BEN HADJ HASSEN ("Company," "we," "us," "our"), a company
        registered in Tunisia.
      </p>
      <p>
        We operate the website{" "}
        <a href="https://bazaar.hassenbenhadjhassen.com" target="_blank">
          https://bazaar.hassenbenhadjhassen.com
        </a>{" "}
      ...
      <p>
        Bazaar Insights is a tool for Hypixel Skyblock players looking to
        enhance their bazaar trading strategies. Our platform offers real-time,
        data-driven insights into the most profitable flips available in the
        bazaar, ensuring that you stay ahead of the market. With advanced
        filtering options, you can tailor the results to your preferences and
        maximize your in-game earnings effortlessly.
      </p>
      <p>
        You can contact us by email at{" "}
        <a href="mailto:hassenbenhadjhassen@gmail.com" target="_blank">
          hassenbenhadjhassen@gmail.com
        </a>
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and HASSEN
        BEN HADJ HASSEN, concerning your access to and use of the Services. You
      ...
      <ol>
        ...
        <li>
          <a href="#purchases-and-payment">PURCHASES AND PAYMENT</a>
        </li>
        <li>
        ...
        <li>
          <a href="#third-party-websites">THIRD-PARTY WEBSITES AND CONTENT</a>
        </li>
        <li>
        ...
        <li>
          <a href="#california-users">CALIFORNIA USERS AND RESIDENTS</a>
        </li>
        <li>
      ...
      <h3 id="third-party-websites">10. THIRD-PARTY WEBSITES AND CONTENT</h3>
      <p>
      ...
      <h3 id="advertisers">11. ADVERTISERS</h3>
      <p>
      ...
      <p>
        ...
        Policy:{" "}
        <a href="https://bazaar.hassenbenhadjhassen.com/privacy">
          https://bazaar.hassenbenhadjhassen.com/privacy
        </a>
        ...
        Services are hosted in Tunisia. If you access the Services from any
        ...
        laws in Tunisia, then through your continued use of the Services, you
        are transferring your data to Tunisia, and you expressly consent to have
        your data transferred to and processed in Tunisia. Further, we do not
      ...
      <p>
        ...
        Tunisia. HASSEN BEN HADJ HASSEN and yourself irrevocably consent that
        the courts of Tunisia shall have exclusive jurisdiction to resolve any
      ...
      <p>
        ...
        jurisdiction of the Tunisia courts. HASSEN BEN HADJ HASSEN shall also
      ...
      <h3 id="california-users">24. CALIFORNIA USERS AND RESIDENTS</h3>
      <p>
