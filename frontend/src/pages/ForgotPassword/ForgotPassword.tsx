        ...
        <div className="forgotpassword_content">
          ...
          <form className="forgotpassword_form" onSubmit={handleSubmit}>
            <p className="forgotpassword__description">
              Please enter your registered email address. We'll send you a link
              to reset your password.
            </p>
            <div className="forgotpassword_inputBox">
              <input
                type="text"
                name="username"
                value={email}
              ...
              />
              <i>Email</i>
              {error && <span className="forgotpassword_error">{error}</span>}
            </div>
